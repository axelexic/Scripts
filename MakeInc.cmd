...
CTFTOOL_HOME=/Users/swami/Workspace/local/bin
...
ifeq ($(RELPATH),)
	export RELPATH := $(CTFTOOL_HOME)/relpath  # $(shell $(XCRUN) -sdk $(SDKROOT) -find relpath)
endif
ifeq ($(STRIP),)
...
ifeq ($(DECOMMENT),)
	export DECOMMENT := $(CTFTOOL_HOME)/decomment # $(shell $(XCRUN) -sdk $(SDKROOT) -find decomment)
endif
ifeq ($(DSYMUTIL),)
	export DSYMUTIL := $(shell $(XCRUN) -sdk $(SDKROOT) -find dsymutil)
endif
ifeq ($(CTFCONVERT),)
	export CTFCONVERT := $(CTFTOOL_HOME)/ctfconvert  # $(shell $(XCRUN) -sdk $(SDKROOT) -find ctfconvert)
endif
ifeq ($(CTFMERGE),)
	export CTFMERGE := $(CTFTOOL_HOME)/ctfmerge #  $(shell $(XCRUN) -sdk $(SDKROOT) -find ctfmerge)
endif
ifeq ($(CTFSCRUB),)
	export CTFSCRUB := $(CTFTOOL_HOME)/ctfdump # $(shell $(XCRUN) -sdk $(SDKROOT) -find ctfdump) -r
endif
ifeq ($(NMEDIT),)
