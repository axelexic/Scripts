;;; yogesh-tango-dark-theme.el --- Tango-based custom theme for faces
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((,class (:foreground , nil :background ,alum-6))))
...
(provide-theme 'yogesh-tango-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; yoegsh-tango-dark-theme.el ends here
